...
export default function ForecastModule() {
  const forecasts = [
    { period: "Tomorrow", occupancy: "94%", adr: "$310", risk: "High", outlook: "Peak convention exit overlap with weekend arrivals." },
    { period: "Next 7 Days", occupancy: "88%", adr: "$265", risk: "Medium", outlook: "Slight dip mid-week before another strong weekend." },
    { period: "Next 30 Days", occupancy: "85%", adr: "$240", risk: "Low", outlook: "Normalizing demand after CES/re:Invent seasonality." }
  ];

  return (
    <div className="card glass-panel" style={{ marginBottom: '2rem', padding: '1.5rem' }}>
      <h3 className="card-title glow-text" style={{ marginBottom: '1.5rem' }}>Vegas Demand Forecast</h3>
